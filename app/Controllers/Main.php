...
class Main extends BaseController
{
    ...
    public function processingBasketDT()
    {
        ...
        for ($i = 0; $i < $totalRows; $i++) {
            ...
            $col['paymentType'] = '<span class="ms-0 me-1"><i data-pay-type="'.$result[$i]->payType.'" data-basket-id="'.$result[$i]->basketID.'" data-action="edit" style="cursor: pointer;" class="edit-payment-method mdi mdi-comment-edit-outline text-warning"></i></span>'.$result[$i]->paymentMethod ;
